...
package com.android.launcher3.banana.icon;
...
public class BananaIconFactory extends BaseIconFactory {

    private final IconPackStore mIconPackStore;

    public BananaIconFactory(Context context, int fillResIconDpi, int iconBitmapSize) {
